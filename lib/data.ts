...
export const DEMO_BOOKINGS: Booking[] = [
  { id: 1, date: "2026-03-03", hour: 14, duration: 4, type: "recording", name: "Marek Nowak", email: "marek@test.pl", phone: "+48 600 100 200", notes: "Sesja wokalna, 3 tracki", status: "confirmed" },
  { id: 2, date: "2026-03-05", hour: 10, duration: 8, type: "mix", name: "Anna Wiśniewska", email: "anna@test.pl", phone: "+48 600 300 400", notes: "Mix albumu", status: "confirmed" },
  { id: 3, date: "2026-03-10", hour: 16, duration: 2, type: "consult", name: "Piotr Zieliński", email: "piotr@test.pl", phone: "+48 600 500 600", notes: "", status: "confirmed" },
];
